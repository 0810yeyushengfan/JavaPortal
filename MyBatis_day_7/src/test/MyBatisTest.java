...
public class MyBatisTest {
     ...
     * 		注意:MappedStatement代表一个增删改查的详细信息
     *
     * 2.获取sqlSession对象:
     ...
     * 		代理对象里面包含了DefaultSqlSession(里面包含Executor和Configuration)
     *
     * 4.执行增删改查方法
     *
     * 总结：
     ...
     *  注意:
     *  	四大对象每个创建的时候都有一个interceptorChain.pluginAll(parameterHandler)，这是使用插件的关键
     */
